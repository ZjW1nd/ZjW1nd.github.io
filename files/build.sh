...
export KERNEL_VERSION=5.10.235
...
echo "CONFIG_KEXEC=y" >> linux-$KERNEL_VERSION/.config
echo "CONFIG_SYSFS=y" >> linux-$KERNEL_VERSION/.config
echo "CONFIG_DEBUG_INFO=y" >> linux-$KERNEL_VERSION/.config

echo "CONFIG_CRASH_DUMP=y" >> linux-$KERNEL_VERSION/.config
echo “CONFIG_PROC_VMCORE=y” >> linux-$KERNEL_VERSION/.config
echo "CONFIG_RELOCATABLE=y" >> linux-$KERNEL_VERSION/.config
